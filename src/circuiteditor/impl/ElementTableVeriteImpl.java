...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Element Table Verite</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link circuiteditor.impl.ElementTableVeriteImpl#getTableVerite <em>Table Verite</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ElementTableVeriteImpl extends ElementCircuitImpl implements ElementTableVerite {
	/**
	 ...
	 * @generated
	 */
	protected ElementTableVeriteImpl() {
		super();
	...
	protected EClass eStaticClass() {
		return CircuiteditorPackage.Literals.ELEMENT_TABLE_VERITE;
	}
	...
	public NotificationChain basicSetTableVerite(TableDeVerite newTableVerite, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CircuiteditorPackage.ELEMENT_TABLE_VERITE__TABLE_VERITE, oldTableVerite, newTableVerite);
	...
	public void setTableVerite(TableDeVerite newTableVerite) {
		if (newTableVerite != tableVerite) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CircuiteditorPackage.ELEMENT_TABLE_VERITE__TABLE_VERITE, newTableVerite, newTableVerite));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CircuiteditorPackage.ELEMENT_TABLE_VERITE__TABLE_VERITE:
				if (tableVerite != null)
					msgs = ((InternalEObject)tableVerite).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CircuiteditorPackage.ELEMENT_TABLE_VERITE__TABLE_VERITE, null, msgs);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CircuiteditorPackage.ELEMENT_TABLE_VERITE___EVALUER:
				return evaluer();
			case CircuiteditorPackage.ELEMENT_TABLE_VERITE___CALCUL_LISTE_ENTREE_BOOLEAN__INT_INT:
				return calculListeEntreeBoolean((Integer)arguments.get(0), (Integer)arguments.get(1));
		}
		return super.eInvoke(operationID, arguments);
	}

} //ElementTableVeriteImpl
