...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Porte OU</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class PorteOUImpl extends PorteStandardImpl implements PorteOU {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected PorteOUImpl() {
		super();
	}
	...
	public EList<Boolean> calculListeEntreeBoolean(int longueurListe, int valeur) {
		EList<Boolean> liste = new EDataTypeUniqueEList<Boolean>(Boolean.class, this, CircuiteditorPackage.LIGNE_TABLE_DE_VERITE__ENTREES);
		...
		for (int i = 0; i < resultat.length(); i++) {
			if (resultat.charAt(i) == '0') liste.add(false);
			else liste.add(true);
		}
	...
	protected EClass eStaticClass() {
		return CircuiteditorPackage.Literals.PORTE_OU;
	}
